...
// 	})
// 	.then((res) => {
// 		let b = res.participants;
// 		console.log(`Количество участников: ${b}`);
// 	})
// 	.catch((err) => {
// 		console.log('Запрос не выполнен!Ошибка!');
// 	})
...
// 		.then((response) => response.json())
// 		.then((data) => {
// 			const resultElem = document.querySelector('#result12');
// 			resultElem.textContent = `${data.lat} ${data.lon}`;
// 		})
// 		.catch((error) => {
// 			console.error('Ошибка:', error);
// 		});
...
// 		.then((response) => response.json())
// 		.then((data) => {
// 			const resElem = document.querySelector('#result14');
// 			resElem.innerHTML= `${data.setup}${data.punchline}`
// 		})
// 		.catch((error) => console.error('Ошибка:', error));
// }
...
// 		const response3 = await fetch('https://jsonplaceholder.typicode.com/users/1');
